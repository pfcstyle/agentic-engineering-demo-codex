...
export const incidents: readonly Incident[] = [
  ...
  { id: 'INC-0002', title: 'Checkout webhook retries', service: 'Payments Events', team: 'Payments', severity: 'Critical', status: 'New', owner: 'Chen Wei', updatedAt: '2026-08-26T09:36:00Z' },
  { id: 'INC-0003', title: 'Settlement reconciliation delay', service: 'Payments Ledger', team: 'Payments', severity: 'Critical', status: 'Mitigated', owner: 'Alex Morgan', updatedAt: '2026-08-26T09:22:00Z' },
  ...
  { id: 'INC-0005', title: 'Identity token validation', service: 'Auth Gateway', team: 'Identity', severity: 'Critical', status: 'New', owner: 'Sam Lee', updatedAt: '2026-08-26T08:57:00Z' },
  ...
  { id: 'INC-0008', title: 'Cart reservation failures', service: 'Cart Service', team: 'Commerce', severity: 'High', status: 'New', owner: 'Chen Wei', updatedAt: '2026-08-26T09:17:00Z' },
  { id: 'INC-0009', title: 'Audit export timeout', service: 'Data Export', team: 'Data', severity: 'High', status: 'Mitigated', owner: 'Nora Singh', updatedAt: '2026-08-26T08:48:00Z' },
  ...
  { id: 'INC-0012', title: 'Log delivery delay', service: 'Observability', team: 'Platform', severity: 'Medium', status: 'New', owner: 'Alex Morgan', updatedAt: '2026-08-26T08:42:00Z' },
  { id: 'INC-0013', title: 'Profile sync conflict', service: 'Identity Profile', team: 'Identity', severity: 'Medium', status: 'Mitigated', owner: 'Maya Ortiz', updatedAt: '2026-08-26T08:31:00Z' },
  ...
  { id: 'INC-0015', title: 'Theme asset cache miss', service: 'Storefront', team: 'Commerce', severity: 'Low', status: 'New', owner: 'Nora Singh', updatedAt: '2026-08-26T08:18:00Z' },
  { id: 'INC-0016', title: 'Certificate rotation notice', service: 'Edge Platform', team: 'Platform', severity: 'Low', status: 'Mitigated', owner: 'Drew Park', updatedAt: '2026-08-26T07:58:00Z' },
